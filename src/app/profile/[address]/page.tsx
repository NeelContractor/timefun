                        ...
                        <div className="bg-gradient-to-r from-pink-950/40 to-purple-950/40 px-8 py-6 border-t border-pink-500/20">
                            <div className="flex items-center justify-between flex-wrap gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm py-1 text-center text-gray-500">your balance: {userATA ? userATA?.balance : 0}</p> {/** TODO: fix it if worng */}
                                    {/* {userATA?.address} */}
                                </div>
                            </div>
                        </div>
...
//     const handleBuy = async () => {
//          if (!publicKey && !profile?.creator && profile === undefined) return;
//          await buyTokensHandler.mutateAsync({ buyerPubkey: publicKey, creatorPubkey: new PublicKey(profile?.creator), amount: new BN(amount) })
//      }
